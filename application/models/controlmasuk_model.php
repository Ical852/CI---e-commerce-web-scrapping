...
class Controlmasuk_model extends CI_Model {
    ...
    public function add()
    {
        ...
        if ($result->num_rows() > 0){
            ...
            if (!$tanggal) {
                $data['msg'][0] = "repeat";
                $data['msg'][1] = "Isi Kolom Tanggal Masuk.....";
            } else if (!$kategoriCabeMasuk) {
                $data['msg'][0] = "repeat";
                $data['msg'][1] = "Isi Kolom Kategori Cabe.....";
            } else if (!$namaCabeMasuk) {
                $data['msg'][0] = "repeat";
                $data['msg'][1] = "Isi Kolom Nama Cabe.....";
            } else if (!$jumlahMasuk) {
                $data['msg'][0] = "repeat";
                $data['msg'][1] = "Isi Kolom Jumlah Masuk.....";
            } else if (!$keterangan) {
                $data['msg'][0] = "repeat";
                $data['msg'][1] = "Isi Kolom Keterangan.....";
            } else if($this->db->simple_query("INSERT INTO produk_masuk(tanggal, kategori_cabe, nama_cabe, jumlah_masuk, keterangan)
