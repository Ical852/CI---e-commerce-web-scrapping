...
<head>
    ...
    <!-- Modernizr JS -->
    <script type="text/javascript" src="<?php echo base_url('assets1/js/vendor/modernizr-2.8.3.min.js');?>"></script>
</head>
...
<body>
    ...
    <script type="text/javascript" src="<?php echo base_url('assets1/js/vendor/jquery-1.12.0.min.js');?>"></script>
    <script type="text/javascript" src="<?php echo base_url('assets1/js/bootstrap.min.js');?>"></script>
    <script type="text/javascript" src="<?php echo base_url('assets1/js/plugins.js');?>"></script>
    <script type="text/javascript" src="<?php echo base_url('assets1/js/slick.min.js');?>"></script>
    <script type="text/javascript" src="<?php echo base_url('assets1/js/owl.carousel.min.js');?>"></script>
    <script type="text/javascript" src="<?php echo base_url('assets1/js/waypoints.min.js');?>"></script>
