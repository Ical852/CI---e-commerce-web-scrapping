...
<a style="color: black;" href="<?php echo site_url ('auth') ?>">
<script src="https://cdnjs.cloudflare.com/ajax/libs/three.js/88/three.min.js"></script>
<script type="text/javascript" src="<?php echo base_url('assets/js/forbidden.js');?>"></script>
<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/css/forbidden.css');?>">
...
<div class="message"><center>
  <strong><p>ACCESS DENIED !!!</p>
  <p>YOU CANCELLED ORDER MORE THAN 5 TIMES !</p>
  <P>TRY ANOTHER DAY !</P>
  <p>GOOD BYE !</p></strong></center>
</div>
</a>